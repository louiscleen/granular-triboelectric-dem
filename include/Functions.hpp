...
bool compute_disk_disk_contact(Disk&,Disk*,double,Eigen::Vector3d&,double,double,double, bool);
bool compute_disk_circular_piston_contact(Disk&,Disk*,double,Eigen::Vector3d&,double,double,double, bool);
bool compute_disk_wall_contact(Disk&,double,Eigen::Vector3d&,double,double,double, bool);
